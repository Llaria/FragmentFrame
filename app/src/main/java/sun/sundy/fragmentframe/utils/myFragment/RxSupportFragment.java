...
public class RxSupportFragment extends RxFragment implements IRxSupportFragment {
    ...
    protected RxSupportActivity _mActivity;
    protected RxFragmentDelegate mFragmentationDelegate;
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof RxSupportActivity) {
            this._mActivity = (RxSupportActivity) activity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            mIsRoot = bundle.getBoolean(RxFragmentDelegate.FRAGMENTATION_ARG_IS_ROOT, false);
            mIsSharedElement = bundle.getBoolean(RxFragmentDelegate.FRAGMENTATION_ARG_IS_SHARED_ELEMENT, false);
            mContainerId = bundle.getInt(RxFragmentDelegate.FRAGMENTATION_ARG_CONTAINER);
        }
        ...
        if (savedInstanceState == null) {
            ...
            mFragmentAnimator = savedInstanceState.getParcelable(RxFragmentDelegate.FRAGMENTATION_STATE_SAVE_ANIMATOR);
            mIsHidden = savedInstanceState.getBoolean(RxFragmentDelegate.FRAGMENTATION_STATE_SAVE_IS_HIDDEN);
            if (mContainerId == 0) { // After strong kill, mContianerId may not be correct restored.
                mIsRoot = savedInstanceState.getBoolean(RxFragmentDelegate.FRAGMENTATION_ARG_IS_ROOT, false);
                mIsSharedElement = savedInstanceState.getBoolean(RxFragmentDelegate.FRAGMENTATION_ARG_IS_SHARED_ELEMENT, false);
                mContainerId = savedInstanceState.getInt(RxFragmentDelegate.FRAGMENTATION_ARG_CONTAINER);
            }
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (mIsRoot) {
            outState.putBoolean(RxFragmentDelegate.FRAGMENTATION_ARG_IS_ROOT, true);
        }
        if (mIsSharedElement) {
            outState.putBoolean(RxFragmentDelegate.FRAGMENTATION_ARG_IS_SHARED_ELEMENT, true);
        }
        outState.putInt(RxFragmentDelegate.FRAGMENTATION_ARG_CONTAINER, mContainerId);
        outState.putParcelable(RxFragmentDelegate.FRAGMENTATION_STATE_SAVE_ANIMATOR, mFragmentAnimator);
        outState.putBoolean(RxFragmentDelegate.FRAGMENTATION_STATE_SAVE_IS_HIDDEN, isHidden());
     ...
     */
    @Override
    public void loadRootFragment(int containerId, RxSupportFragment toFragment) {
     ...
     */
    @Override
    public void replaceLoadRootFragment(int containerId, RxSupportFragment toFragment, boolean addToBack) {
     ...
     */
    @Override
    public void loadMultipleRootFragment(int containerId, int showPosition, RxSupportFragment... toFragments) {
     ...
     * <p>
     * 建议使用更明确的{@link #showHideFragment(RxSupportFragment, RxSupportFragment)}
     *
     * @param showFragment 需要show的Fragment
     */
    @Deprecated
    @Override
    public void showHideFragment(RxSupportFragment showFragment) {
     ...
     */
    @Override
    public void showHideFragment(RxSupportFragment showFragment, RxSupportFragment hideFragment) {
     ...
     */
    @Override
    public void start(RxSupportFragment toFragment) {
        start(toFragment, STANDARD);
    }

    @Override
    public void start(final RxSupportFragment toFragment, @LaunchMode final int launchMode) {
        mFragmentationDelegate.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, launchMode, RxFragmentDelegate.TYPE_ADD);
    }

    @Override
    public void startForResult(RxSupportFragment toFragment, int requestCode) {
        mFragmentationDelegate.dispatchStartTransaction(getFragmentManager(), this, toFragment, requestCode, STANDARD, RxFragmentDelegate.TYPE_ADD_RESULT);
    }

    @Override
    public void startWithPop(RxSupportFragment toFragment) {
        mFragmentationDelegate.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, STANDARD, RxFragmentDelegate.TYPE_ADD_WITH_POP);
    }

    @Override
    public void replaceFragment(RxSupportFragment toFragment, boolean addToBack) {
     ...
     */
    @Override
    public RxSupportFragment getTopFragment() {
     ...
     */
    @Override
    public RxSupportFragment getTopChildFragment() {
     ...
     */
    @Override
    public RxSupportFragment getPreFragment() {
     ...
     */
    @Override
    public <T extends RxSupportFragment> T findFragment(Class<T> fragmentClass) {
        return mFragmentationDelegate.findStackFragment(fragmentClass, null, getFragmentManager());
    }

    @Override
    public <T extends RxSupportFragment> T findFragment(String fragmentTag) {
        RxFragmentDelegate.checkNotNull(fragmentTag, "tag == null");
     ...
     */
    @Override
    public <T extends RxSupportFragment> T findChildFragment(Class<T> fragmentClass) {
        return mFragmentationDelegate.findStackFragment(fragmentClass, null, getChildFragmentManager());
    }

    @Override
    public <T extends RxSupportFragment> T findChildFragment(String fragmentTag) {
        RxFragmentDelegate.checkNotNull(fragmentTag, "tag == null");
    ...
    public void setFragmentResult(int resultCode, Bundle bundle) {
        ...
        if (args == null || !args.containsKey(RxFragmentDelegate.FRAGMENTATION_ARG_RESULT_RECORD)) {
            return;
        }

        ResultRecord resultRecord = args.getParcelable(RxFragmentDelegate.FRAGMENTATION_ARG_RESULT_RECORD);
    ...
    private void dispatchFragmentLifecycle(int lifecycle, Bundle bundle, boolean visible) {
        ...
        _mActivity.dispatchFragmentLifecycle(lifecycle, RxSupportFragment.this, bundle, visible);
    }
