...
public class SwipeBackLayout extends FrameLayout {
    ...
    private RxSupportFragment mFragment;
    ...
    public void setFragment(RxSupportFragment fragment, View view) {
    ...
    class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent > 1) {
                if (mFragment != null) {
                    if (mPreFragment instanceof RxSupportFragment) {
                        ((RxSupportFragment) mPreFragment).mLocking = true;
                    }
                    if (!mFragment.isDetached()) {
                        mFragment.popForSwipeBack();
                    }
                    if (mPreFragment instanceof RxSupportFragment) {
                        ((RxSupportFragment) mPreFragment).mLocking = false;
                    }
                } else {
