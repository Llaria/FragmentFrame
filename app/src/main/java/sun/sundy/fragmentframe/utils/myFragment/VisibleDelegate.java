...
public class VisibleDelegate {
    ...
    private RxSupportFragment mSupportFragment;

    public VisibleDelegate(RxSupportFragment fragment) {
            ...
            if (fragmentManager != null) {
                ...
                if (childFragments != null) {
                    for (Fragment child : childFragments) {
                        if (child instanceof RxSupportFragment && !child.isHidden() && child.getUserVisibleHint()) {
                            ((RxSupportFragment) child).getVisibleDelegate().dispatchSupportVisible(visible);
                        }
                    }
                }
            }
